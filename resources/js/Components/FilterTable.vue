   ...
   <PrincipalContainer>
        <form class="flex items-center pb-3" action>   
            ...
            <div class="w-1/2 mt-6">
                <button @click="searchUsers" type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded text-sm px-5 py-2.5 text-center mx-2">
                    Search
                </button>
                <button @click="callUserPage" type="button" class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded text-sm px-5 py-2.5 text-center mr-2">
                    <strong>New</strong>
                </button>
            </div>
        </form>
